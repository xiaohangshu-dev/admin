...
var (
	...
	ErrPermEmpty             = &Error{Code: 20002, Err: errors.New("permission is empty")}       // 权限标识为空
	ErrRouteEmpty            = &Error{Code: 20003, Err: errors.New("route is empty")}            // 路由为空
	ErrIconEmpty             = &Error{Code: 20004, Err: errors.New("icon is empty")}             // 图标为空
	ErrDescEmpty             = &Error{Code: 20005, Err: errors.New("description is empty")}      // 描述为空
	ErrFunctionAlreadyExists = &Error{Code: 20006, Err: errors.New("permission already exists")} // 权限已存在
